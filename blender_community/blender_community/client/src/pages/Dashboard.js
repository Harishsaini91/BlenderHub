...
const menuItems = ["Profile", "Connect People", "Team Request", "Stats", "Messages", "Notification","AITools","MainProjectView","Mutual_project_scroller"];
    ...
    <div className="dashboard">
      ...
      <div className="main-area">
        ...
        <div className="left-panel">
          ...
          {activeKey === "MainProjectView" && <MainProjectView user={user} />}
          {activeKey === "Mutual_project_scroller" && <Mutual_project_scroller user={user} />}
